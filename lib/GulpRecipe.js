...
var GulpRecipe = Class.extend(Obj, {
     ...
     * @return {Recipe}
     */
    defineRecipe: function(recipeName, recipeObject) {
    ...
    getRecipe: function(recipeName) {
        ...
        return function() {
            ...
            return _this.loadRecipe(recipeName)
                .then(function(elfRecipe) {
                    console.log("running recipe ", recipeName);
                    return elfRecipe.runRecipe(gulpArgs.concat(recipeArgs));
                });
        }
    },
    ...
    findAndDefineRecipe: function(recipeName) {
        ...
        return this.defineRecipe(recipeName, recipeObject);
    },
